...
Od strony statystycznej analiza rozpoczęła się od weryfikacji kompletności danych. Występowanie brakujących wartości mogło wpłynąć na końcowe wyniki, dlatego przeprowadzono wizualizację tych braków oraz tam, gdzie było to konieczne, zastosowano odpowiednie metody imputacji.
